...
{
    public class RelayBoardItemInfo : BoardItemInfo
    {
        public RelayBoardItemInfo()
        {
            InitEditCommand();
        }
        ...
        private void InitEditCommand()
        {
            EditCommand = new RelayCommand(() =>
                                           {
                                               var sbi = new SelectBoardItemDialog(ProjectHelper.Project.ItemXmlInfo.OutputBoardGroup, true);
