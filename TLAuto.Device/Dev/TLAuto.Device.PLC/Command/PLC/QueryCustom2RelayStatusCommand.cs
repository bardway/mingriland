...
{
    public class QueryCustom2RelayStatusCommand : PLCDeviceCommand<IEnumerable<RelayItem>>
    {
        public QueryCustom2RelayStatusCommand(int deviceNumber, int itemCount)
