...
{
    public class QueryCustom2SwitchStatusCommand : PLCDeviceCommand<IEnumerable<SwitchItem>>
    {
        public QueryCustom2SwitchStatusCommand(int deviceNumber, int itemCount) :
            base(deviceNumber, itemCount) { }

        /// <summary>
        /// 0代表设备号
        /// </summary>
        protected override string SendCommand => "AA BB {0} 0D 01";
