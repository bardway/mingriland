...
{
    public class TLAutoCustom2PLCDeviceSerialPort : TLAutoCustomBasePLCDeviceSerialPort
    {
        private readonly string _logModuleName;
        private readonly int _timeOutMs;

        public TLAutoCustom2PLCDeviceSerialPort(TLAutoDeviceSerialPort tlAutoDeviceSerialPort, bool hasControlRelayResultStatus, string logModuleName = null, int timeOutMs = 5000) :
        ...
        {
            var sendCommand = new QueryCustom2SwitchStatusCommand(deviceNumber, itemCount);
        ...
        {
            var sendCommand = new QueryCustom2RelayStatusCommand(deviceNumber, itemCount);
